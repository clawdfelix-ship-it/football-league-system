...
export default async function MatchSheet({ params }: { params: Promise<{ teamId: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-4 print:p-0 print:bg-white print:h-screen match-sheet">
      ...
      {/* ══════════════════════════════════════════════
          A4 container — 210mm × 297mm (FULL HEIGHT)
      ...
      >
        ...
        >
          <div style={{ fontSize: '10.5pt', fontWeight: 900, letterSpacing: '0.09em', fontStyle: 'italic', lineHeight: 1.0, color: 'black' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.8mm', fontSize: '5.5pt', fontWeight: 700, lineHeight: 1.1 }}>
                ...
                <div key={i} style={{ border: '1px solid #aaa', padding: '0.3mm', display: 'flex', flexDirection: 'column', gap: '0.1mm' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      ...
                      <div style={{ fontSize: '3.5pt', color: '#666', marginTop: '0.05mm' }}>簽名</div>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      <div style={{ width: '14mm', borderBottom: '1px solid black', height: '3mm' }} />
                      <div style={{ fontSize: '3.5pt', color: '#666', marginTop: '0.05mm' }}>日期</div>
                    </div>
                  </div>
                </div>
              ))}

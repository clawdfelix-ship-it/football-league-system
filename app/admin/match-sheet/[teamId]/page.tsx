...
export default async function MatchSheet({ params }: { params: Promise<{ teamId: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-4 print:p-0 print:bg-white print:h-screen match-sheet">
      ...
      {/* ══════════════════════════════════════════════
          A4 container — 210mm × 290mm (BALANCED FIT)
          5 columns for player grid (40mm each = 200mm wide)
          
          Layout breakdown (total: 290mm, leaves 7mm margin):
          - Padding: 4mm × 2 = 8mm
          - Header: 16mm
          - Section label: 3mm
          - Gaps: 1mm × 6 = 6mm
      ...
      >
        ...
        >
          <div style={{ fontSize: '11.5pt', fontWeight: 900, letterSpacing: '0.1em', fontStyle: 'italic', lineHeight: 1.1, color: 'black' }}>
